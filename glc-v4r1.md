...
This manual explains the correct equipment usage procedures for users of the GL controller and is intended primarily for trained engineers and technicians. Please carefully read this manual to ensure satisfactory and safe usage of the test chamber. 
...
- Definition of an experienced engineer:
  A person who understands the purpose of use of the chamber; who has received training in the operation method, daily maintenance and inspections, etc.; who can foresee and prevent risks associated with common sources of hazards, such as electricity, etc. 
...
- Labels that indicate information on physical damage and environment contamination.
...
| Ensure the equipment clearly displays that it is being operated remotely; and also properly notify the operator. | 
...
![GL Controller display with temperature and humidity](https://bitbucket.org/repo/yRoG7Eb/images/1866183695-S4_3-home-page-000.PNG)


## 1.5 Manuals 

The user's manual package that came with the chamber contains the following reference materials. Refer to the appropriate manual according to the information required. 

| Manual   | Content |
|----------|---------|
| GL Chamber Operation Manual | Explains the operation and features of the GL test chamber | 
...
| GL Options Manual | Explains optional features of GL test chamber | 
...
|The touchscreen provides complete control and operation of the chamber and the GL controller| Any web-based device on the network can access the GL controller and its user interface for control and operation. |
|Update or upgrade is provided via USB external port.  | Update on the GL controller is provided via Mender cloud service.  |


### 2.1.1 GL Controller: Standalone System

By default, the GL controller operates as a standalone system. Complete control and operation of the instrumentation are achieved via the dedicated (touchscreen) HMI on the chamber, as depicted in the following diagram.

![GL controller as a standalone system](https://bitbucket.org/repo/yRoG7Eb/images/3326729188-S1_1_1-standalone-001a.PNG)
...
![GL controller as a networked system](https://bitbucket.org/repo/yRoG7Eb/images/300662906-S1_1_2-networked-002a.PNG)
...
| Submenu | Feature / Configuration Options|
|------|-------------------------------------------|
...
| (5) | Set Buttons       | Displays a set of quick-access setting buttons for users, date/time and language|
| (6) | Secondary Buttons  | Displays secondary buttons for the selected menu. The edit button (pen icon) allows the user to edit the layout. For example, the four menu buttons can be replaced with other menus or button selected from a different menu for quick access.  |
...
![Features of Operation Mode](https://bitbucket.org/repo/yRoG7Eb/images/715538957-S1_2_2-op-mode-000a.PNG)

| No.| Name             | Description: Function/Operations  |
| ---|------------------|---------------------------------- |
...
![The Setup page](https://bitbucket.org/repo/yRoG7Eb/images/160479785-S4_3_5-setup-page-001b.PNG)
...
| 3   | Set Protection | Provides an option for users to set HMI automatic login with On/Off options (available for HMI operation only)  |
...
An alternate way to directly access the **Setup** menu and its submenus altogether is via the Hamburger menu in the status bar, as depicted below.
...
![Task bar showing common operation buttons and components](https://bitbucket.org/repo/yRoG7Eb/images/1559059139-status-bar-hmi-n-web-001a.PNG)
...
2. The GL controller system starts. Within in a minute, the HMI display comes on. The GL controller system automatically logs the default user in for operation. 
    ...
    ![GL controller system touch-screen display](https://bitbucket.org/repo/yRoG7Eb/images/2008961489-S4_3-fig1.PNG)
...
![Login status on Web display; GL system is ready for operation.](https://bitbucket.org/repo/yRoG7Eb/images/1615289703-S1_6-web-login-status-001a.PNG)
...
### 2.7.2 System Menu via Menu Buttons 
...
## 2.8 Setting the Alarm and Warning Buzzer
...
1. From the main home page, press the hamburger button (1) in the status bar to access the system menu. Press **Configuration** (2), followed by **Set Sound** submenu (3).
    ...
    ![Accessing sound setting options](https://bitbucket.org/repo/yRoG7Eb/images/3588522138-S1_7-step1.PNG)

2. By default, the Alarm volume and Warning volume are at maximum setting, as indicated by the volume slider bar.

    ![Alarm and Warning beep level](https://bitbucket.org/repo/yRoG7Eb/images/1253536369-S1_7-step2-000.PNG)
...
4. To turn off the beep volume, either press the speaker icon (1) or set the volume level on the slider bar to its minimum setting (2). 
    ...
    ![Beep volume adjustment](https://bitbucket.org/repo/yRoG7Eb/images/2697260505-S1_7-step4a.PNG)
...
5. Press the Save button (3) to save the setting. To cancel the setting, press the Back button (4) and press Yes to confirm the cancel.
    ...
    ![Save the beep volume setting](https://bitbucket.org/repo/yRoG7Eb/images/4264269375-S1_7-step5a.PNG)

| CAUTION |
|---------|
|**It is strongly advised to keep the beep on whenever possible to prevent any delay in the detection of an alarm or warning.**  <br> <br> If the beep is turned off, alarm and warning are not notified with sound and are indicated only with red blinking of the operation lamp and on warning occurrence screen. <br> <br> **Set the beep volume in accordance with the ambient environment.** |
...
3. Configuration options are spread over in two pages, as depicted in the figure, to allow configuration for all options, such as Set Point, High & Low Limits, Time Signals and Product Temperature Control (if available). To set Time Signals and Product Temperature Control options, select page 2.    
    ...
    ![Constant 1 configuration options](https://bitbucket.org/repo/yRoG7Eb/images/2211636124-S6_2_2-p1-step5.PNG)
...
4. Press the set point field of temperature (see arrow). Adjust the set point value of temperature in the keypad. Press the check button to apply the input value; or press anywhere outside of the keypad to close it and apply the setting. Set values take effect immediately after the check button is applied and the keypad closes.    
    ...
    ![Adjust temperature set point value](https://bitbucket.org/repo/yRoG7Eb/images/41414174-S6_3_step6-001b.PNG)
...
5. Humidity control can be turned ON/OFF as needed. When the Off button is unlit (black), humidity is OFF. To turn on humidity, press the On button. Press the set point field of humidity (see arrow) to adjust the set point value via the keypad. Press the check button in the keypad to apply the input value. Set values take effect immediately after the check button is applied and the keypad closes.
    ...
    ![Setting humidity set point](https://bitbucket.org/repo/yRoG7Eb/images/1582714919-S5_8_3-step7b.PNG)
...
6. As depicted in the figure, refrigeration capacity is available in auto and manual (off, 25%, 50%, 75% and 100%). Default setting is in auto (see arrow). To select between the manual capacity, press the desired refrigeration capacity. The selected option will lit and take effect immediately. 
    ...
    ![Set refrigeration to Auto](https://bitbucket.org/repo/yRoG7Eb/images/2003532222-S6_5_1-step4a.PNG)
...
7. When finished setting temperature (and humidity), press the Operation Mode in the Menu bar (1) or press an area near or on the Standby in the status bar (2) to start **Constant 1** mode.  
    ...
    ![Returning to the Operation Mode page](https://bitbucket.org/repo/yRoG7Eb/images/1669112367-S6_3-step8-000a.PNG)
...
![Example 1: Humidification delay control.](https://bitbucket.org/repo/yRoG7Eb/images/1910060217-S2_3-fig-ex1.PNG)
...
![Example 2: Humidification delay control.](https://bitbucket.org/repo/yRoG7Eb/images/4227507477-S2_3-fig-ex2.PNG)

| **Reference**|
|--------------|
| The temperature attainment range of the humidification delay control is set to 1 &deg;C and the temperature attainment time is set to 60 seconds; both settings are fixed and cannot be changed. <br> <br> Even if the **attainment judgment criteria** on the maintenance setting screen change, they have no bearing in the operation of this function. | 
...
## 4.1 What is a Constant Value Operation?
...
![Graph of constant value operation](https://bitbucket.org/repo/yRoG7Eb/images/1695782616-S3_1-const-temp-op-01.PNG)

## 4.2 Constant Temperature (& Humidity) Setup
...
3. Press **Constant 1** in the title bar to access **Constant 1** configuration page (see arrow). Three constant modes (No. 1, 2, and 3) are available for configuration and operation. 
    ...
    ![Select and configure Constant 1 Mode](https://bitbucket.org/repo/yRoG7Eb/images/2344501277-S3_2-step3-002a.PNG)
...
4. Under the **Set Point** panel, configuration options are available for Temperature, Humidity and Refrigeration, followed by **Time Signals**, **Product Temperature Control** (if available) and **High & Low Limits** panels through this scrollable page.    
    ...
    ![Constant 1 configuration options](https://bitbucket.org/repo/yRoG7Eb/images/252542159-S3_2-step4-002.PNG)
...
5. To set new temperature set point, press the set point field (see arrow). Adjust the set point value in the keypad. Press the check button (or anywhere outside the keypad) to apply the input value. Set temperature mode by selecting Product or Air (See arrow).     
    ...
    ![Adjust temperature set point value](https://bitbucket.org/repo/yRoG7Eb/images/1731941424-S3_2-step5-002-1a.PNG)
...
6. Humidity control can be turned On/Off as needed. The set point can only be adjusted when humidity is On. When the Off button is unlit (black), humidity is Off. Press the On button (see arrow) to turn it on. Press the set point field (see arrow) to adjust the set point value via the keypad. 
    ...
    ![Setting humidity set point](https://bitbucket.org/repo/yRoG7Eb/images/2996209063-S3_2-step6-002a.PNG)
...
1. The **Set Point** panel in the figure (below) shows the refrigeration set in Auto mode. 
    ...
    ![Refrigeration settings](https://bitbucket.org/repo/yRoG7Eb/images/3555960265-S3_3-step1-001a.PNG)
...
| Reference |
|-----------|
| For details on refrigeration setup, see Section 3.1. <br> <br> When you want to change the mode from Auto to Manual during operation, manually set the capacity of the refrigerator using one of these options: 25%, 50%, 75% or 100%. When refrigeration is changed from Auto to Manual (with specified capacity), refrigeration stops immediately. This may cause control to become unstable. | 
| When refrigeration is set to Auto, the manual setting is not reflected in the operation of the refrigeration system.| 
...
![High/Low limit setup condition](https://bitbucket.org/repo/yRoG7Eb/images/1025545634-S3_4-HL-graph.PNG)
...
2. From within the main home page, press the **Set Mode** button and press **Constant 1** title bar to open its configuration page (see arrow). 
    ...
    ![Constant 1 configuration page](https://bitbucket.org/repo/yRoG7Eb/images/1005458508-S3_4a-step2-000a.PNG)

3. Press the **Abs. High** value field to bring up the numeric input keypad.

    ![Adjusting Abs. High, Abs. Low temperature/humidity](https://bitbucket.org/repo/yRoG7Eb/images/468327071-S3_4-step3-002a.PNG)
...
4. Enter a new temperature value on the keypad, taking note of the high and low limits. Press the check button to apply the new setting. To cancel the procedure, press the X button. Repeat the same procedure for the upper/lower deviation or humidity setting. 
    ...
    ![Enter new temperature setting](https://bitbucket.org/repo/yRoG7Eb/images/1648987967-S3_4-step4-002a.PNG)
...
![Chamber with eight (8) time signal options](https://bitbucket.org/repo/yRoG7Eb/images/1592840808-S3_5-TS-example-001.PNG)

**Example 2:** Time signal options using default and custom names 

![Chamber with ten (10) time signal options](https://bitbucket.org/repo/yRoG7Eb/images/3237501349-S3_5-TS-example-002.PNG)
...
2. Press the **Hamburger** menu (1) in the status bar. Check to confirm the floating keyboard is enabled. A diagonal bar over the keyboard indicates it is disabled. Press the keyboard (2) to enable it. Press **Configuration** (3); then press **Time Signal Names** (4). 
    ...
    ![Accessing Time Signal Setting](https://bitbucket.org/repo/yRoG7Eb/images/1569113829-S3_5-step3-000b.PNG)
...
3. To customize the name of Time Signal 1, press the Full name field (1). Enter a new name using the pop-up input keyboard (2). *Note: If the input keyboard does not pop up, it has not been enabled; go back to Step 2.* Press the Check button (3) to apply the setting. Press the Save button (4) to save the setting. Or, press the Back button (5) to cancel the setting (and press Yes to confirm the action).     
    ...
    ![Customize Time Signal names](https://bitbucket.org/repo/yRoG7Eb/images/3757672429-S3_5-step3-TS-000b.PNG)

4. Short name (second column) and On/Off buttons (third and fourth columns) can also take descriptive names.

    ![Renaming Time signal 1](https://bitbucket.org/repo/yRoG7Eb/images/2218355775-S3_5-step4-TS-rename.PNG)
...
5. Time signal can be operated via the On/Off button. This operation can be set using the On/Off button in the Constant configuration page (Constant 1 setting is depicted in the figure below). In Program mode, time signal is identified by its number (discussed in Chapter 5). As shown below, Time Signal 1 (now called _**Control Ext1**_) is in the OFF position. To turn it on, press the **RUNNING** button. 
    ...
    ![Enabling Time Signal operation](https://bitbucket.org/repo/yRoG7Eb/images/1843822913-S3_5-step5-002a.PNG)
...
6. The Full name of a time signal will appear in the standard display area during a Constant or Program operating mode as depicted in the figure. 
    ...
    ![How time signal is displayed during an chamber operation](https://bitbucket.org/repo/yRoG7Eb/images/3939821181-S3_5-step6-001a.PNG)


## 4.6 Setting Constant Name 
...
2. Press **Constant 1** in the title bar (see arrow) to access **Constant 1** configuration page. 
    ...
    ![Select and configure Constant 1 Mode](https://bitbucket.org/repo/yRoG7Eb/images/244552609-S3_6-step2-accessing-const1-000a.PNG)
...
3. Press the constant name field (1), edit the name using the pop-up keyboard (2) and press the check button (3) to apply the setting. The new name takes effect immediately. 
    ...
    ![Renaming Constant 1](https://bitbucket.org/repo/yRoG7Eb/images/136012415-S3_5-step3-002a.PNG)
...
2. From within the main home page, press the **Set Mode** button and press **Constant 1** title bar to open its configuration page (see arrow). 
    ...
    ![Constant 1 configuration page](https://bitbucket.org/repo/yRoG7Eb/images/382946587-S3_7-step2-002a.PNG)
...
3. Press the **Product** button to turn on Product Temperature control (see arrow). With the **Product** option set to ON (button lit), the system performs product temperature control. With the **Product** option set to OFF (button unlit), the system does not perform product temperature control.
    ...
    ![Enabling product temperature control feature](https://bitbucket.org/repo/yRoG7Eb/images/21606746-S3_7-step3-002a.PNG)

4. Scroll up the page and press the **Upper Dev.** value field to bring up the numeric input keypad.

    ![Accessing PTCON Upper/Lower  Dev.](https://bitbucket.org/repo/yRoG7Eb/images/33917969-S3_7-step4-002a.PNG)
...
5. Enter upper deviation value on the keypad, taking note of the high and low limits. *Note: The system ignores any value higher or lower than the required range.* Press the check button (or anywhere outside of the keypad) to apply the new setting. New value takes effect immediately. 
    ...
    ![Enter new temperature setting](https://bitbucket.org/repo/yRoG7Eb/images/3799326284-S3_7-step5-002a.PNG)
...
| **Reference**|
|--------------|
| When conducting a test of the electronic components make certain that the specimen has not been affected by condensation. <br><br> Condensation occurs when the surface temperature of the specimen is lower than the dew-point temperature of the air in the test area. To avoid condensation of the specimen, it is necessary to perform temperature-only operation in advance and start temperature/humidity control operation after the surface temperature of the specimen reaches equilibrium with the temperature in the test area. <br><br> In addition, condensation can be avoided by using humidification delay control. If the temperature and humidity in the test area is 85 &deg;C and 85% RH, respectively, the dew-point temperature of the air in the test area is 80.9 &deg;C. Therefore, condensation occurs if the surface temperature of the specimen is less than 80.9 &deg;C.  |
...
1. From within the main home page, press the **Operation Mode** menu (1) or button (2). Refer to Section 2.3.2 for details.  
    ...
    ![Accessing Constant Operation Mode](https://bitbucket.org/repo/yRoG7Eb/images/4158085756-S3_8_1-step1-main-home-page.PNG)
...
2. Check the set points (Temperature, Humidity) displayed in the panel of **Constant 1** (see arrow). **_Note:_** To check other options, it may require accessing the **Constant 1** setup page. 
    ...
    ![Checking Constant 1 set point values](https://bitbucket.org/repo/yRoG7Eb/images/1211506617-S3_8_1a-step1-000a.PNG)
...
1. From within the main home page, press the **Operation Mode** menu (1) or button (2). Refer to Section 2.3.2 for details. 
    ...
    ![Accessing the Operation Mode page](https://bitbucket.org/repo/yRoG7Eb/images/4273468635-S3_8_2-step1.PNG)    

2. Press the **Stop** button (1) or **Constant 1** panel (2), then press Yes in the Attention box (3) to confirm the action. 

    ![Stopping Constant 1 Operation Mode](https://bitbucket.org/repo/yRoG7Eb/images/2158917054-S3_8_2a-step2-stop-0002a.PNG)
...
![Information of Temp/Humi for Constant 2 in Home page](https://bitbucket.org/repo/yRoG7Eb/images/1758750591-S3_9A-homepage-001a.PNG)
...
![S4_9_2-page1-stdby-001a.PNG](https://bitbucket.org/repo/yRoG7Eb/images/2518384625-S4_9_2-page1-stdby-001a.PNG)

**Monitor Page 1**: Constant Mode

![Monitor Page 1: Information page of Constant mode](https://bitbucket.org/repo/yRoG7Eb/images/267390292-S4_9_2-page1-const-001a.PNG)
...
![Monitor Page 2, displaying information of Standby mode](https://bitbucket.org/repo/yRoG7Eb/images/3369992751-S3_9_3-standby-page2aaa.PNG)

**Monitor, Page 2:** Constant Mode 

![Monitor Page 2, displaying information of Constant mode](https://bitbucket.org/repo/yRoG7Eb/images/1705672758-S3_9_3-const-page2-001a.PNG)
...
![Detailed page of operating mode](https://bitbucket.org/repo/yRoG7Eb/images/2240131210-S3_9_4-fig-stdby-000aaa.PNG)
...
![Details page of Constant Mode](https://bitbucket.org/repo/yRoG7Eb/images/906783355-S3_9_4-fig-const-000aa.PNG)
...
![Detailed summary of parameters of current Constant Mode](https://bitbucket.org/repo/yRoG7Eb/images/1714391146-S3_9_5-fig-detail-const-000.PNG)
...
![Trend graph of collected data](https://bitbucket.org/repo/yRoG7Eb/images/1180964563-S3_9_7-trend-graph-const-000.PNG)
...
![Trend graph showing plots of current data from the chamber](https://bitbucket.org/repo/yRoG7Eb/images/1729650781-S3_9_7-trend-graph-const-001a.PNG)
...
![Trend Graph manipulation buttons](https://bitbucket.org/repo/yRoG7Eb/images/3772339018-trend-graph-manip-buttons-001abc.PNG)
...
![Step-wise program operation](https://bitbucket.org/repo/yRoG7Eb/images/714097117-S4_1-fig-001a.PNG)
...
![Program Setup panel containing empty list](https://bitbucket.org/repo/yRoG7Eb/images/1416653409-S4_2-prog-setup-panel-001.PNG)

The following figure depicts a Program Setup panel that contains programs on the list as well as empty ones (slot 3 and 5). 

![Program Setup panel containing ](https://bitbucket.org/repo/yRoG7Eb/images/3235188799-S4_1_2-exiting-progs-on-list-001.PNG)
...
![Three tabs of the Program Setup panel](https://bitbucket.org/repo/yRoG7Eb/images/640037717-S4_2_2-prgm-setup-page-002c.PNG)
...
![Creating program using step-wise option](https://bitbucket.org/repo/yRoG7Eb/images/2110777582-S5_3-fig2-001a.PNG)

The following figure depicts the layout and components (and parameters) of the selected step for editing. 

![Components of program step](https://bitbucket.org/repo/yRoG7Eb/images/3576817940-S5_3-step-wise-programming-001a.PNG)
...
![Creating program using table option](https://bitbucket.org/repo/yRoG7Eb/images/128661161-S4_2_2-create-prgm-table-wise-001a.PNG)
...
![Detail page of program creation](https://bitbucket.org/repo/yRoG7Eb/images/1432725829-S4_2_2-create-prgm-detail-wise-001a.PNG)
...
3. Press Program 1 slot (plus symbol), followed by the **Editor** button (pen icon) in the pop-up window. The X button can be used to cancel the action.
    ...
    ![Open program editor](https://bitbucket.org/repo/yRoG7Eb/images/527372288-S5_3_1-step3-003a.PNG)
...
4. Press the body of Step 1 (see arrow). To cancel the current setting, press the X button. We outline from top to bottom on how to apply each parameter as follows. 
    ...
    ![Edit step elemenets](https://bitbucket.org/repo/yRoG7Eb/images/103026662-S5_3_1-step4-002a.PNG)
    ...
    - **Apply Settings:** Press the checkmark button (see arrow, above) to apply the settings and close the current Step panel. **_Note:_** The previous (<) and next (>) buttons can be used to nagivate between the previous and next steps without closing the Step panel.  
...
7. To edit an existing step (say, Step 2), press the body of the step (see arrow). Modify the contents of Step 2 in the step panel (see arrow). Press the **Details** button to adjust any configuration. Press the checkmark button to apply the new settings. Press the Save button (which becomes visible after closing the step panel with the checkmark) to save the program. 
    ...
    ![Editing existing steps](https://bitbucket.org/repo/yRoG7Eb/images/634398287-S5_3_1-step7-003a.PNG)
...
8. To traverse between existing steps within the program, with Step 2 selected as the starting point (see arrow), press the left-arrow button (see arrow) or the right-arrow button (see arrow). Press the checkmark followed by the save button to save the new setting. 
    ...
    ![Traversing between existing steps](https://bitbucket.org/repo/yRoG7Eb/images/3726944312-S5_3_1-step8-001a.PNG)
...
9. A selected step may be moved backward or forward using the **Move Before** (<) or **Move After** (>) button. Press the Step 2 header (see arrow), then press the **Move Before** button to move Step 2 to before Step 1. As a result, the locations of Step 1 and Step 2 are swapped. To move Step 2 to the position after Step 3, press the Step 2 header (see arrow), then press the **Move After** button. As a result, the locations of Step 2 and Step 3 are swapped.
    ...
    ![Relocating a selected step](https://bitbucket.org/repo/yRoG7Eb/images/2445926883-S4_3_1-step9-001a.PNG)
...
10. To insert a step before or after Step 2, press the Step 2 header (see arrow), then press the **Insert Step Before** or **Insert Step After** button to insert a new step in the desired location. The **Delete Step(s)** button can be used to delete the selected step (Step 2, in this case).   
    ...
    ![Inserting a step between existing steps](https://bitbucket.org/repo/yRoG7Eb/images/2445926883-S4_3_1-step9-001a.PNG)
...
11. To copy contents of Step 2 into a new step between Step 2 and Step 3, press Step 2 header (see arrow) followed by **Copy Step(s)**, then press Step 2 header (again) to confirm the selection; press Step 3 header and press Yes to confirm the action. To cancel the operation, press **No** followed by **Cancel** in the lower corner. 
    ...
    ![Copying step contents](https://bitbucket.org/repo/yRoG7Eb/images/2445926883-S4_3_1-step9-001a.PNG)
...
12. To copy a range of steps (say, Step 1 through 2) and put them in between Step 2 and Step 3, press Step 1 header (1) followed by **Copy Step(s)**, then press Step 2 header (2) to confirm the range, press Step 3 header (3) and press Yes (4) to confirm the action. To cancel the operation, press **No** followed by **Cancel** in the lower corner. (Actual programming examples will be provided later.)  
    ...
    ![Copying a range of steps](https://bitbucket.org/repo/yRoG7Eb/images/131982083-S4_3_1-step11b.PNG)
...
13. To delete a range of steps (say, Step 2 through 3), press Step 2 header (1) followed by **Delete Step(s)**, then press Step 3 header (2) to confirm the range and press Yes (3) to confirm the action. To cancel the operation, press **No** followed by **Cancel** in the lower corner. **_Note:_** Operation can be done in reserve order, namely, starting with Step 2 as the initial step followed by Step 1. 
    ...
    ![Deleting Step 2 and 3](https://bitbucket.org/repo/yRoG7Eb/images/1018220975-S4_3_1-step13-000a.PNG)
...
14. To save program (in the current slot), press the **Save** button in the secondary menu (see top arrow). To save program in the next slot, press the **Save** button in the secondary menu (see bottom arrow). 
    ...
    ![Saving the program](https://bitbucket.org/repo/yRoG7Eb/images/28056107-S4_2_2-step11-000a.PNG)

| Note on Product Temperature Control |
|---------|
| As stated in Step 4, when product temperature control (if available) is On, the system performs product temperature control. The deviation limits are the allowable air temperature deviation from product temperature (P.Temp) set point under P.Temp control mode. The "plus" (+) value will be added to the P.Temp set point to create the "upper" (or High) air temperature limit. The "minus" (-) value will be subtracted from the P.Temp set point to create the "lower" (i.e., Low) air temperature limit. <br> <br> When the P.Temp process value is further from the P.Temp set point, the controller will "drive" the air temperature set point to this maximum upper (or lower) deviation limit. As the P.Temp process value gets closer to the P.Temp set point, the air temperature set point will change such that the effect is less than the maximum upper (or lower) deviation limit. <br> <br> The High and Low deviation can be adjusted via the **Details** tab by setting the Dev.High and Dev.Low values in the High & Low Limits panel in the appropriate fields. Refer to Section 5.3.3. |

| How to Determine the High and Low Deviation Limits |
|---------|
| If the operator is unsure of what value to set for the Dev.High and Dev.Low, the following procedure can help to determine the proper temperature offset. **_Note:_** This method requires that the operator has some way of measuring both product and air temperature process values, such as a recorder or a temperature meter. <br> <br> (1) Run the chamber with the selected test product to the desired P.Temp set point with product temperature control turned OFF. Run this "test" in constant mode. <br> <br> (2) When the air temperature has reached the desired set point, record the temperature difference between the product and the air temperature. This temperature difference will be used as the deviation limit setting. <br> <br> (3) Enter the recorded value (from Step 2) into the (+) setting for product heat up. Enter the value into the (-) setting for product cool down. <br> <br> (4) Execute this procedure for heat up and cooling cycles in order to determine the upper (+) and lower (-) deviation limits. <br> <br> (5) During product temperature control, the response characteristic of control differs depending on the heat capacity, heat-transfer coefficient, and thermal conductivity of the control target specimen. Since the required control parameters are also changed, set the appropriate values accordingly. |

| Setting Refrigeration in the **_Details_** subpage |
|---------|
| Occasionally, automatic refrigeration control during linear ramping, test  steps may cause non-linear ramping results. If this was observed to be the case, please contact ESPEC North America Inc. customer service for assistance; you will be provided with some guidelines on how to program your test profile to use manual refrigeration control for better ramping. <br><br> Additionally, there are some specific circumstances where you may be required to use manual refrigeration control to run a specific test profile. An example of this kind would be to use manual refrigeration to execute a "pre-chill" function with the refrigeration system of your test chamber. <br><br> This "pre-chill" function can be used to maximize the temperature change rate of the chamber. This setting should be used when transitioning from a set point above ambient to a low temperature. The pre-chill setting is accomplished by setting the manual refrigeration control to 25% output 3-5 minutes before the transition taking place. This will start the refrigeration system and pre-cool the cascade of the system to ensure that maximum capacity is available for the transition. When the temperature transition is started, the refrigeration should be returned to “auto” control. This method can be used in constant mode or program mode operation. <br><br> **_Note:_** When refrigeration is set Auto, the manual setting is not reflected in the operation of the refrigeration system. You cannot change the refrigeration capacity during operation. Set the refrigeration capacity when setting the program prior to oepration. |


| Configuring Loop Counter in the **_Details_** subpage |
|---------|
| In counter setup, the number of repetitions of a step or group of steps can be configured.  |
...
3. Press Program 1 slot (plus symbol, first arrow), followed by the Editor button (pen icon, second arrow) in the pop-up window.
    ...
    ![Selecting Table-wise program editor](https://bitbucket.org/repo/yRoG7Eb/images/3607149254-S5_3_2-step3-002a.PNG)
...
4. Press the **Table-Wise** subpage (1) to turn on the table-wise editor. The program begins with Step 1 with some preselected parameters, such as the High/Low Dev., preconfigured in the **Details** page.   
    ...
    ![Creating program using table option](https://bitbucket.org/repo/yRoG7Eb/images/765730781-S4_3_2-step4-002b.PNG)
...
5. Complete Step 1 by entering parameter values for temperature, humidity and operation time (hour, minute and second) in their designated fields. Click the radio button under Temperature Mode (see arrow) to select control mode from the list. Repeat the same procedure for humidity mode (see arrow) and refrigeration capacity mode (see arrow). Each time signal (TS) can be turned On by placing a checkmark in the box; press on the box under the desired TS. **_Note:_** Time signal control can be turned On/Off after the parameter values are entered. Therefore, Step 1 instructions involve a 2-step process, with time signal control being the last step to complete. 
    ...
    ![Complete instructions in Step 1](https://bitbucket.org/repo/yRoG7Eb/images/2813460863-S4_3_2-step5-002a.PNG)
...
6. Create Step 2 by pressing the **Append** button and filling in all the required fields with parameter values. Additional program steps can be repeated using the same process. A program consisting of five steps is depicted below. 
    ...
    ![Five program steps have been created.](https://bitbucket.org/repo/yRoG7Eb/images/3810732043-S4_3_2-step6-002.PNG)
...
7. A new step can be added (inserted) in between existing steps via the **step manipulation** menu, which can be invoked by pressing on an input field (e.g., Hrs field or Set Point field) in the selected step (until the menu appears). In the figure, the Hrs input field of Step 3 (see arrow) was momentarily depressed to bring up the **step manipulation** menu (red rectangle), which consists of **add above**, **delete (x)** and **add below** buttons. A new step can be inserted above or below an existing step using the (+) above or (+) below button. Press the (+) button at Step 2 to insert a new step in between Step 1 and Step 2.  Press the (+) button at Step 4 to insert a new step in between Step 4 and Step 5. 
    ...
    ![Inserting steps in between existing steps](https://bitbucket.org/repo/yRoG7Eb/images/3446697236-S4_3_2-step7-002a.PNG)
...
8. The **step manipulation** menu can be shifted along existing steps with the **delete (x)** button on the selected step (see arrows). To delete Step 2, press the input field of Step 2 (see arrow), then press the **delete (x)** button. To delete Step 4, press the input field of Step 4 (see arrow), then press the **delete (x)** button.
    ...
    ![Deleting steps using the X button](https://bitbucket.org/repo/yRoG7Eb/images/2061477884-S4_3_2-step8-003ab.PNG)
...
9. To save program (in the current slot), press the **Save** button in the secondary menu (1). To save program in the next slot, press the **Save** button in the secondary menu (2).   
    ...
    ![Saving current program](https://bitbucket.org/repo/yRoG7Eb/images/1955823295-S4_3_2-step9-003a.PNG)
...
![Configuring options in program features and modes](https://bitbucket.org/repo/yRoG7Eb/images/3522713967-S4_3_3-details-page-001ab.PNG)
...
![Set start conditions for Temp and/or Humi](https://bitbucket.org/repo/yRoG7Eb/images/1759555740-temp-humi-start-conditions-001.PNG)
...
![Graphs of ramp operation and conditions from Step 1](https://bitbucket.org/repo/yRoG7Eb/images/1123077062-S5_3_3-start-cond-001.PNG)
...
### 5.3.4 Example 1: Creating a Program using Step-Wise Method
...
2. Press **Program 1** panel (see top arrow), then press the Edit button (see bottom arrow) in the pop-up window to access Program 1 edit page for programming. 
    ...
    ![Select Program 1 for profile creation](https://bitbucket.org/repo/yRoG7Eb/images/3607149254-S5_3_2-step3-002a.PNG)
...
4. Press the **Temp** box (see arrow) and enter 85. Press **Enable** (see arrow) under Humi to turn it on and adjust set value (from 5) to 10 RH. Set operation time to 1 hour: **Hrs** to 1, **Mins** and **Secs** to 0. Step 1 summary page is shown in the right for reference. The first nine time signals are set to Off (unselected).  
    ...
    ![Creating Step 1; setting Temp value and duration](https://bitbucket.org/repo/yRoG7Eb/images/2365826148-S4_3_4-step4-000c.PNG)
...
5. By default, refrigeration is set to Auto and time signals are set to Off. Press the **Details** button at the bottom of Step 1 summary page (refer to the above figure and/or see arrow in the following figure) to confirm refrigeration and time signals settings. Press the checkmark (see arrow) to complete Step 1 programming. **_Note_**: The right/left buttons are for navigating through program steps forward or backward. Since only one step is being created thus far, these buttons are not yet fully operational. 
    ...
    ![Confirm refrigeration and time signals configuration](https://bitbucket.org/repo/yRoG7Eb/images/680538036-S4_3_4-step5-003ab.PNG)
...
6. Press the **Details Page** (see arrow) to access program details page for configuring program start/stop mode, Absolute High/Low limits for temperature and humidity. **_Note_**: The slider bar and left/right paging buttons are for traversing through program steps. 
    ...
    ![Accessing detail page of Step 1](https://bitbucket.org/repo/yRoG7Eb/images/1996146587-S4_3_4-step5-002a.PNG)
...
7. The default program name is **Program 1**. Press the program name field (see arrow) and enter **Humidity Points** for program name. By default, program start mode consists of both temperature and humidity without initial set point values, which means the chamber will raise ambient temperature (inside the chamber) to the set point specified in Step 1. Program will stop when it completes all the steps. Adjust the Absolute High and Low Limits (see arrows) for temperature values as desired. **_Note_**: The High/Low limits only affect the current program being edited; they will not affect any other programs or constant modes. Press the **Save** button (see arrow) to save the settings. 
    ...
    ![Set Program name and temp/humi high/low limits](https://bitbucket.org/repo/yRoG7Eb/images/87363343-S6_2_3-step8a.PNG)
    ...
    **Upper deviation temperate limit**: This setting is designed to protect specimens against damage by heat. It also triggers a safety device inside the chamber, which causes the heater output to set at 0% output. When temperature returns within range, normal control is restored automatically.   
...
9. The completed program is illustrated in the following figure. The slider bar and paging buttons can now to be used to traverse between program steps. The trend graph illustrates the output of the program, showing what the program will do when it is executed. This trend graph is extremely useful for previewing the program output to study its results. Press the **Save** button (top arrow) to save the program in the current slot (i.e., Program 1). **_Note_**: The **Save As** button (middle arrow) can be used to save the program in a different slot. The reverse button (last arrow) can be used to cancel or revert the action.  
    ...
    ![Program 1 with 15 steps](https://bitbucket.org/repo/yRoG7Eb/images/2752159224-S4_3_4-step9-000a.PNG)

10. Press Yes to confirm the action (saving). Program 1 is now saved in slot 1.   

    ![Saving Program 1](https://bitbucket.org/repo/yRoG7Eb/images/2410566821-S4_3_4-step10-000.PNG)


### 5.3.5 Example 2: Creating a Program with Table-Wise Method
...
2. Press **Program 2** panel (see top arrow), then press the Edit button (see bottom arrow) in the pop-up window to access Program 2 edit page for programming. 
    ...
    ![Select Program 2 for profile creation](https://bitbucket.org/repo/yRoG7Eb/images/103476112-S5_3_5-step2-002a.PNG)

3. Press the Table-wise editing page (see arrow) to display the program edit table. 

    ![Selecting Table-Wise programming method](https://bitbucket.org/repo/yRoG7Eb/images/2698228481-S4_3_5-step3-000a.PNG)
...
4. Edit Step 1 by entering the values as indicated by the four arrows. By default, humidity mode is set to Off. Press the down arrow icon (see arrow) to select On from the menu and enter 10 for humidity set point. The rest of the parameters are set by default. Press the **Append** button (see arrow) to add Step 2 and proceed to the next step. 
    ...
    ![Edit Step 1 of Program 2](https://bitbucket.org/repo/yRoG7Eb/images/482900626-S4_3_5-step4-001a.PNG)
...
5. Complete Step 2 of the program by editing the temperature set point to 60 (refer to the table above); the rest of the values and parameters remain the same (as in Step 1). 
    ...
    ![Complete Step 2 of the program](https://bitbucket.org/repo/yRoG7Eb/images/2936436928-S4_3_5-step5-000.PNG)
...
6. Use the values in the above table to complete the remaining 6 steps in the program, as depicted below. The default settings for program start/stop modes are identical to those in Section 5.3.4; and they will be used here also and therefore no need to access the **Details** page (with the exception if program name needs editing). The vertical slider bar and paging buttons (on the right) can be used to traverse through program steps for editing. The horizontal slider bar has two small arrows. The right arrow slides the table leftwards to display the remaining time signals; the left arrow slides back the table. Press the **Save** button to save the program.        
    ...
    ![Program 2 completion](https://bitbucket.org/repo/yRoG7Eb/images/2812727144-S4_3_5-step6-000a.PNG)
...
![Editing, Exporting, Importing options](https://bitbucket.org/repo/yRoG7Eb/images/828421102-S5_4-import-export-opt-001a.PNG)
...
![Three export options are available](https://bitbucket.org/repo/yRoG7Eb/images/1888251991-S5_4-import-export-003a.PNG)
...
1. Plug in a USB device into the USB port (see arrow) at the front of the chamber. 
    ...
    ![External ports](https://bitbucket.org/repo/yRoG7Eb/images/4208992695-S4_4_1-image-step1a.PNG)

2. Access (or press) **Set Mode** 

3. Press **Program 1**

    ![Exporting Program 1](https://bitbucket.org/repo/yRoG7Eb/images/692073832-S5_4_1-step4-001a.PNG)
...
The following figures depict Program-1 in JSON and MS Excel file. It requires some programming skills to read JSON file. However, the MS Excel file lends itself readily to a wider audience.  

**JSON Format:** Program 1 displayed as standard ASCII format

![Program 1 in JSON format](https://bitbucket.org/repo/yRoG7Eb/images/3523103571-S5_4_1-prog1-json.PNG)

**MS Excel:** Program 1 displayed as a spreadsheet using MS Excel program 

![Program 1 in MS Excel format](https://bitbucket.org/repo/yRoG7Eb/images/3129773071-S5_4-excel-003b.PNG)
...
3. Press **Program 3**
    ...
    ![Importing Program 3](https://bitbucket.org/repo/yRoG7Eb/images/3508985049-S5_4_2-image-001a.PNG)
...
5. The imported program is now stored in slot 3. 
    ...
    ![Imported program in Slot 3](https://bitbucket.org/repo/yRoG7Eb/images/1493040258-S4_4_2-step6-00-.PNG)


### 5.4.3 Moving or Swapping a Program 
...
1. Press Program 3 (see top arrow). Press **Move/Swap** button in the Program 3 drop-down panel (see arrow).  
    ...
    ![Selecting Program 3 for Move/Swap operation](https://bitbucket.org/repo/yRoG7Eb/images/2943978485-S5_4_3-step1-003a.PNG)
...
2. The blue pop-up notification (in lower right) indicates Program 3 has been selected for Move/Swap operation. To cancel the action, press **Cancel** in the notification. **_Note:_** Moving over to a different menu will also cancel the Move/Swap action. Click Program 4 (see arrow) to move Program 3 in 4. 
    ...
    ![Select Program 4 to move Program 3 in](https://bitbucket.org/repo/yRoG7Eb/images/511542172-S5_4_3-step3-001a.PNG)

3. Confirm the action with Yes in the dialog box.

    ![Confirm the Move action](https://bitbucket.org/repo/yRoG7Eb/images/4087364197-S5_4_3-step4-001.PNG)

4. Program 3 has been move into Program 4. Slot 3 is now empty, as shown in the figure.

    ![Program 3 has been move and slot3 is now empty](https://bitbucket.org/repo/yRoG7Eb/images/534048827-S5_4_3-step5-001.PNG) 
...
1. Press Program 2 (see arrow). Press **Rename** button in the Program 2 drop-down panel (see arrow). 
    ...
    ![Rename Program 2](https://bitbucket.org/repo/yRoG7Eb/images/2459717929-S5_4_4-step1-002a.PNG)
...
2. Clear the "Program 2" and enter "TempTest", then press Ok. To cancel the action, press **Cancel**. **_Note:_** Moving over to a different menu will also cancel the Rename action.
    ...
    ![Edit program name](https://bitbucket.org/repo/yRoG7Eb/images/4022731286-S5_4_4-step2-002.PNG)

3. Program 2 has been renamed to "TempTest", as shown in the figure. 

    ![Program 2 has been renamed.](https://bitbucket.org/repo/yRoG7Eb/images/395812864-S5_4_4-step3-001.PNG)
...
1. Press Program 4 (see arrow). Press **Preview** button in the Program 4 drop-down panel (see arrow). 
    ...
    ![Selecting Program 4 for preview](https://bitbucket.org/repo/yRoG7Eb/images/1150784192-S5_4_5-step1-002a.PNG)
...
2. By default, contents of Program 4 are displayed for preview in Step-Wise mode. Click Table-Wise option to display Program 4 in that mode. **_Note:_** In preview mode, program and its contents cannot be edited or changed. 
    ...
    ![Program 4 in preview mode](https://bitbucket.org/repo/yRoG7Eb/images/3001426492-S5_4_5-step2-001.PNG)
...
1. Press Program 4 (see arrow). Press **Delete** button in the Program 4 drop-down panel (see arrow). 
    ...
    ![Selecting Program 4 for removal from the program list](https://bitbucket.org/repo/yRoG7Eb/images/2644696631-S5_4_6-step1-002a.PNG)
...
2. Program 4 (and its slot) is immediately removed from the list, along with empty slot 5, leaving just slot 3 ready to be populated by a new program. 
    ...
    ![Slots prior to slot 4 are available](https://bitbucket.org/repo/yRoG7Eb/images/3848750984-S5_4_6-step2-001a.PNG)
...
### 5.5.1 Delete Steps in a Program 
...
3. Press Program 2 (see top arrow), followed by the **Editor** button in the Program 2 drop-down panel. 
    ...
    ![Selecting Program 2 for editing](https://bitbucket.org/repo/yRoG7Eb/images/1494949465-S5_5_1-step3-002ab.PNG)

4. Press Step 2 header (see top arrow), followed by the **Delete** button in the drop-down panel (bottom arrow).

    ![Selecting Step 2 in the program](https://bitbucket.org/repo/yRoG7Eb/images/442520040-S5_5_1-step4-001a.PNG)
...
5. Press Step 2 header again (see top arrow) to mark the range of steps for deletion, as instructed in the blue pop-up notification (bottom right). Press Yes to confirm the action in the pop-up dialog box. To cancel the current action, press No in the dialog box, followed by the **Cancel** button in the blue pop-up notification (lower right). **_Note:_** Moving over to a different menu (e.g., Table-Wise editing page) will also cancel the current action.  
    ...
    ![Marking Step 2 for deletion](https://bitbucket.org/repo/yRoG7Eb/images/4207147614-S5_5_1-step5-001a.PNG)
...
6. Step 2 is removed immediately; and Step 3 now becomes Step 2 (as can be verified by their parameters). Press the **Save** button, followed by Yes in the dialog box, to write the changes back into slot 2.   
    ...
    ![Saving the changes in Program 2](https://bitbucket.org/repo/yRoG7Eb/images/1660515446-S5_5_1-step6-001a.PNG)
...
1. Continuing from the previous procedure, press Step 5 header (see arrow), followed by the **Delete** button in the drop-down panel. 
    ...
    ![Selecting Step 5 to set range of step removal](https://bitbucket.org/repo/yRoG7Eb/images/2020061316-S5_5_1-step1a-002a.PNG)

2. Press Step 7 (see arrow) to mark the range of steps for deletion.  

    ![Selecting Step 7 to mark selection](https://bitbucket.org/repo/yRoG7Eb/images/2633614511-S5_5_1-step2a-002a.PNG)

3. Press Yes to confirm the action. 

    ![Confirm step 5-7 removal](https://bitbucket.org/repo/yRoG7Eb/images/2810292390-S5_5_1-step3a-002a.PNG)
...
4. Step 5 through 7 are removed immediately, as shown in the following figure. Press Save (see arrow) to save the changes in the program. 
    ...
    ![Save changes to the program](https://bitbucket.org/repo/yRoG7Eb/images/3179553772-S5_5_1-step4a-003a.PNG)

### 5.5.2 Moving Steps within the Program  
...
![Contents of Program 2](https://bitbucket.org/repo/yRoG7Eb/images/3572524222-S5_5_2-orig-image.PNG)

**_Procedure:_** Move Step 3 to after Step 6. 
...
2. Press Step 3 (see top arrow). The drop-down panel appears. **_Note:_** To cancel current operation, press X to close out the drop-down panel.
    ...
    ![Selecting Step 3 to be moved](https://bitbucket.org/repo/yRoG7Eb/images/1702048269-S5_5_2-step2-001a.PNG)
...
3. Press **Move After** four times until Step 7 is highlighted as shown below; that is, Step 3 has moved into Step 7 (with Step 7 now becoming Step 6).  
    ...
    ![Relocate Step 3 to after Step 7 with **Move After**](https://bitbucket.org/repo/yRoG7Eb/images/722400340-S5_5_2-step3-001a.PNG)

4. Press X close the drop-down panel. 

    ![Close the drop-down panel](https://bitbucket.org/repo/yRoG7Eb/images/3886719421-S5_5_2-step4-001a.PNG)

5. Press the **Save** button (see arrow) to save the changes. 

    ![Save the changes back in the original program](https://bitbucket.org/repo/yRoG7Eb/images/840120071-S5_5_2-step5-001a.PNG)

### 5.5.3 Inserting Steps in the Program 
...
2. Press Step 3 (see arrow), followed by the **Insert Before** button in the drop-down panel (see arrow). **_Note:_** To cancel the current action before committing to insert, press X.  
    ...
    ![Inserting new step before Step 3](https://bitbucket.org/repo/yRoG7Eb/images/26673975-S5_5_2-step2-001a.PNG)
...
3. Step panel is open with parameters prefilled. Modify the parameters using the contents in the above table. Press the **Check** button to apply the settings. **_Note:_** The left or right button in the step panel has the same effect as the **Check** button. However, the X button does not apply the changes; it instead uses (i.e., writes) the default parameters in the inserted step. 
    ...
    ![Editing contents for the new step](https://bitbucket.org/repo/yRoG7Eb/images/2059538172-S5_5_2-step3-002a.PNG)

4. Press **Save** to apply the changes in Program 2. 


**_Procedure:_** Table-Wise Method

1. Assuming this activity is continued from Section 5.5.2, press **Program 2**, followed by the **Editor** button in the drop-down panel. 
2. Press the Table-Wise subpage (see arrow). 

    ![Setting Table-wise editing mode](https://bitbucket.org/repo/yRoG7Eb/images/1154104584-S5_5_2-step2a-001a.PNG) 

3. Press Step 4 (see arrow), then press the add above icon on Step 3 (see arrow).

    ![Inserting new step above Step 3](https://bitbucket.org/repo/yRoG7Eb/images/1635463010-S5_5_3-step3aa-001a.PNG) 
...
3. Edit the parameters in Step 3 using the contents in the above table. Press **Save**, followed by Yes in the dialog (pop-up) box to apply the changes in Program 2. 
    ...
    ![Saving changes in Program 2](https://bitbucket.org/repo/yRoG7Eb/images/2418808331-S5_5_3-step4a-001a.PNG)

### 5.5.4 Cutting/Pasting Steps within the Program 
...
2. Press Step 3 header, followed by the **Cut/Paste Step(s)** button in the drop-down panel. 
    ...
    ![Selecting initial step](https://bitbucket.org/repo/yRoG7Eb/images/2928284305-S5_5_4-step2-001a.PNG)

3. Press Step 5 to mark the range. 

    ![Selecting final step to set the range](https://bitbucket.org/repo/yRoG7Eb/images/2651171131-S5_5_4-step3-002a.PNG) 

4. Press Step 1, followed by Yes in the dialog box to confirm the action.

    ![Selecting Step 1 to paste the selected steps](https://bitbucket.org/repo/yRoG7Eb/images/2300914669-S5_5_4-step4-001a.PNG)
...
5. Step 3-5 should now be pasted in front of Step 1. Press **Save** to save changes to the program, followed by Yes to confirm the action. 
    ...
    ![Save the changes to the program](https://bitbucket.org/repo/yRoG7Eb/images/2767006148-S5_5_4-step5-001a.PNG)


## 5.6 Executing Programs   
...
![How to execute a program](https://bitbucket.org/repo/yRoG7Eb/images/3645024435-S5_6-start-stop-program-001a.PNG)
...
![Program Run panel layout and operation buttons](https://bitbucket.org/repo/yRoG7Eb/images/3657323916-S5_6_1-prog-list-001b.PNG)

| No. | Name         | Description and Operation |
|-----|--------------|---------------------------|
...
![Program execution options and features](https://bitbucket.org/repo/yRoG7Eb/images/1159962881-S5_6_2-start-001a.PNG)
...
![Program execution error messages and queue](https://bitbucket.org/repo/yRoG7Eb/images/960069550-S5_6_2-exec-error-001.PNG)
...
![Executing a Program from within the Home Page](https://bitbucket.org/repo/yRoG7Eb/images/3602099353-S5_6_3-execute-in-home-001a.PNG)
...
![Default home page pin setting](https://bitbucket.org/repo/yRoG7Eb/images/3611225745-S5_6_4-home-page-001a.PNG)
...
![Home page in edit mode](https://bitbucket.org/repo/yRoG7Eb/images/3605228041-S5_6_4-home-page-002a.PNG)
...
1. Press **Home** (see arrow), followed by the **Edit** button in the secondary menu (see arrow). 
    ...
    ![Activating home page edit mode](https://bitbucket.org/repo/yRoG7Eb/images/3241351464-S5_6_3-execute-in-home-002a.PNG)

2. Press the **Edit** button of **Start Constant 1** (see arrow). 

    ![Editing the Start/Stop button](https://bitbucket.org/repo/yRoG7Eb/images/665574343-S5_6_3-step2-001a.PNG)
...
3. Press **Operation Mode** (see arrow). **_Note:_** To cancel, press **Close**; to delete the current button, press **Delete**. Use the **Delete** button with caution as it requires adding the widget back into the spot. If you accidentally pressed **Delete**, press **Back** in the secondary menu to cancel this task. Refer to Section 6.12 for details.  
    ...
    ![Accessing the Operation Mode](https://bitbucket.org/repo/yRoG7Eb/images/1329716152-S5_6_3-step3-001a.PNG)

4. Press **Program 1** (see arrow) to select Program 1 (Range Checker).   

    ![Select Program 1](https://bitbucket.org/repo/yRoG7Eb/images/2509727079-S5_6_3-step4-001a.PNG)
...
5. Press **Start Program** (see arrow) to set execution with step 1 by default. A desired step may be selected before pressing **Start Program**. However, in this example, there is only one step; and therefore, step selection is defaulted to step 1.   
    ...
    ![Set default step to start execution](https://bitbucket.org/repo/yRoG7Eb/images/1600152636-S5_6_3-step5-001a.PNG)

6. Press the check mark (see arrow), followed by Yes in the Attention dialog box to save the current settings.  

    ![Saving the changes to the home page](https://bitbucket.org/repo/yRoG7Eb/images/4290535785-S5_6_3-step6-001a.PNG)

7. Program 1 is now pinned to the home page as shown. 

    ![Program 1 pinned to the home page](https://bitbucket.org/repo/yRoG7Eb/images/2745408708-S5_6_3-step7-001a.PNG)
...
![Program being executed cannot be edited and saved](https://bitbucket.org/repo/yRoG7Eb/images/1693827026-S5_6_4-exec-during-op-001.PNG)
...
![Deleting a program during its execution](https://bitbucket.org/repo/yRoG7Eb/images/1336002044-S5_6_4-delete-during-exec-001b.PNG)
...
![Operating status of program mode](https://bitbucket.org/repo/yRoG7Eb/images/822631156-S5_7_0-monitor-002a.PNG)
...
![Monitor Page 1, displaying information of Program mode](https://bitbucket.org/repo/yRoG7Eb/images/555507061-S5_7_0-monitor-001a.PNG)
...
![Monitor Page 2, displaying information of Program mode](https://bitbucket.org/repo/yRoG7Eb/images/3574379521-S5_7_2-monitor-p2-001a.PNG)
...
![Detailed page of operating mode](https://bitbucket.org/repo/yRoG7Eb/images/883617183-S5_7_3-monitor-p3-001aa.PNG)
...
![Detailed summary of parameters of current Program Mode](https://bitbucket.org/repo/yRoG7Eb/images/2942269458-S5_7_4-monitor-details-002a.PNG)
...
![Details outputs of program during execution](https://bitbucket.org/repo/yRoG7Eb/images/923638922-S5_7_5-monitor-preview-002a.PNG)
...
![Execution status of a program, step by step](https://bitbucket.org/repo/yRoG7Eb/images/3856978094-S5_7_5-monitor-preview-003.PNG)
...
![Trend graph of collected data](https://bitbucket.org/repo/yRoG7Eb/images/2746091548-S5_7_6-trend-003.PNG)
...
![Trend graph showing plots of current data from the chamber](https://bitbucket.org/repo/yRoG7Eb/images/2268754256-S5_7_6-trend-003a.PNG)
...
![Setup menu in the menu bar](https://bitbucket.org/repo/yRoG7Eb/images/1028195047-S5-main-setup-menu-000a.PNG)
...
![Setup menu via the system menu of the hamburger button](https://bitbucket.org/repo/yRoG7Eb/images/1370477211-S5-main-setup-sys-menu-000ab.PNG)
...
![Example of one-time and repeated timer operation](https://bitbucket.org/repo/87eopek/images/4083199896-illustrationtimer--001a.PNG)
...
4. Select/confirm that **One Time** is selected from the drop-down list of the **Timer** type; by default, **One Time** is selected.
    ...
    ![Setting a one-time automation](https://bitbucket.org/repo/87eopek/images/689094357-one-shot-timer-000a.PNG)
...
5. Touch or click the date/time field under the **Timer Properties** and apply the calendar and time to set the desired time. **Note**: Date and time must be ahead of the current date and time on the GL controller system. 
    ...
    ![Set date/time for a one-shot action](https://bitbucket.org/repo/87eopek/images/3455739059-date-time-001aaa.PNG)
    ...
    **Note**: For a one-time operation, it is easier to use the Offset button (on the right of the date/time field) to adjust the future time, as depicted by the arrows in the following figure. Here, the GL controller will add the time to the current time to calculate when this action will fire.
    ...
    ![Using the time-offset calculator](https://bitbucket.org/repo/87eopek/images/2503503837-calendar-offset-001aa.PNG)
...
9. Apply the setting with the **APPLY** button
    ...
    ![Program mode for a one-time start](https://bitbucket.org/repo/87eopek/images/1332814146-set-program-mode-1.PNG)
...
![Setting additional one-shot timer after the first](https://bitbucket.org/repo/87eopek/images/2397509582-set-new-timmer-003.PNG)
...
8. Apply the setting with the **APPLY** button. The timer is now saved in the Macros list. 
    ...
    ![Scheduled a one-time timer to set chamber in Constant mode](https://bitbucket.org/repo/87eopek/images/122092262-p300-timer-prog-to-const-001.PNG)
...
9. The timer is activated at the set time, as depicted in the Macros list under the Operation Timer 1 script. To view the Operation Timer 1 action, access the Settings menu and select Macros from the submenu. 
    ...
    ![Macros action recorded on the one-time Timer](https://bitbucket.org/repo/87eopek/images/4142389927-p300-timer-prog-to-const-001a.PNG)
...
11. Apply the setting using the **APPLY** button. The complete configuration is depicted in the following example. 
    ...
    ![Single-day weekly timer](https://bitbucket.org/repo/87eopek/images/2240313602-p300-timer-prog-repeatedly-001.PNG)
...
10. Apply the settings with the **APPLY** button. The complete configuration is depicted in the following figure. 
    ...
    ![Timer setting for everyday of the week](https://bitbucket.org/repo/kMrjrgg/images/777446160-es102-prog-run-weekly-001b.PNG)
...
![Trend graph of chamber controlled by a timer](https://bitbucket.org/repo/87eopek/images/2656486419-ex10_7_4ab.PNG)
...
### 6.1.6 Multiple Timers: One-Time or Repeated Daily/Weekly 
...
![Multiple sequential timer oeprations](https://bitbucket.org/repo/87eopek/images/3002991730-multiple-tiemrs-s1076.PNG)
...
Contents in the trend graph of the **Monitor** menu are dictated by the settings on this page. Data points collected from the chamber will bear a date/time stamp of the GL controller system. For practical purposes, date/time of the GL controller should reflect the current date and local time zone. Refer to Section 7.2 for details on how to adjust date/time on the GL controller. 

The **Set Sampling** page consists of three main components: (1) data logging frequency, (2) data logging mode and (3) logging items. As depicted in the following figure, item 4 is the button to clear and delete data in the log file. It is highly recommended to clear (i.e., delete) the data log regularly to avoid mass data accumulation both to protect and maintain data storage space and the overall responsiveness of the GL controller system. Data log can be downloaded for archive. Refer to Section 4.9.8 or 5.7.7 for details.   

![Options of the Set Sampling page](https://bitbucket.org/repo/yRoG7Eb/images/3644375677-S5_3-set-sampling-001a.PNG)

| Number | Name               |Description/Operation |
|--------|--------------------|----------------------|
...
Data logging is controlled by the sampling frequency (Item 1) and chamber operating mode (Item 2). The default sampling frequency occurs at a 5-second interval. An arbitrary value can be used to set the sampling frequency in Item 1. Two operating modes are available to control data logging: **Always** and **Running**. When **Always** is selected, data will be logged at all time. When **Running** is selected, data will be logged only when the chamber is running, both in Constant and Program mode. 

Data points and types (such as, temperature, humidity, etc.) can be manually selected to appear in the trend graph. Selection can be made based on the check mark placed in their respective boxes (shown in the following figure). This page is scrollable to allow all available items be selected and included in the data log. Color decoration can be selected for plot legends. Different logs for a trend graph can be created using the (+) button. The y-axis (vertical) scaling can be adjusted via the Y Axis Max and Y Axis Min buttons. Detailed steps for these settings are discussed in the following sections. 

![Item selection, data type and color options](https://bitbucket.org/repo/yRoG7Eb/images/3968747127-S6_3-set-sampling-003a.PNG)
...
2. Press the **Hamburger** menu (1) in the status bar. Check to confirm the floating keyboard is enabled. A diagonal bar over the keyboard indicates it is disabled. Press the keyboard (2) to enable it. Press **Setup** (3) followed by **Set Sampling** (4). 
    ...
    ![Accessing the Set Sampling page](https://bitbucket.org/repo/yRoG7Eb/images/2960242964-S5_3_1-step1-001a.PNG)
...
3. Press the **Delete all Logged Data** button (see callout 1) to reset data log file. Press the sampling frequency field (see callout 2) and set the value to 5 via the pop-up keypad (not shown). Press the **Always** button (see callout 2). Press the **Save** button to save the current settings. 
    ...
    ![Setting up data log file](https://bitbucket.org/repo/yRoG7Eb/images/3028734154-S5_3_1-step3-001aa.PNG)
...
2. Apply *default* setting and select *status*, *Temp Air SP*, *Temp Prod. SP*, and their counter PV, then save the settings with the **Save** button in the secondary menu. Access **Monitor** and select **Trend** subpage as shown below. 
    ...
    ![Default log setting](https://bitbucket.org/repo/yRoG7Eb/images/2342323574-S6_3_3-step2-001.PNG)
...
8. Press **Monitor**, followed by the **Trend** submonitor page. The log being displayed is the *default* log. 
    ...
    ![Trend of default log setting](https://bitbucket.org/repo/yRoG7Eb/images/3813115736-S6_3_3-step8-002.PNG)

9. Press the **Trend** icon in the upper-right (see arrow 1) and check the *custom1* box (arrow 2) to display *custom1* log.   

    ![Selecting custom log](https://bitbucket.org/repo/yRoG7Eb/images/1616083375-S6_3_3-step9-0022a.PNG)

10. Trend graph based on *custom1* is now displayed, which can be compared to the *default* log. 

    ![Trend graph of custom setting](https://bitbucket.org/repo/yRoG7Eb/images/186329913-S6_3_3-step10-002.PNG)
...
2. Press **Setup** in the menu bar (see arrow 1). Press the **Alarm/Operation History** tab (see arrow 2). 
    ...
    ![Accessing the Alarm/Operation History page](https://bitbucket.org/repo/yRoG7Eb/images/4247892763-S5_4-accessing-hist-page-001a.PNG)
...
![Operation history of the chamber](https://bitbucket.org/repo/yRoG7Eb/images/3791077674-S5_4-alarm-main-page-001aa.PNG)
...
![List of Alarm/Warning](https://bitbucket.org/repo/yRoG7Eb/images/2664764610-S5_4_1-alarm-list-002a.PNG)
...
**_Procedure:_** Example 

1. Locate the **Overheating Alarm**, as depicted in the figure below. Press the trend graph icon (see arrow). 

    ![Viewing trend graph and details of the selected alarm](https://bitbucket.org/repo/yRoG7Eb/images/2310942176-S5_4_1-step1-002a.PNG) 
...
2. The timeline in the trend graph indicated that **Overheating Alarm** occurred between 3:41 PM and 3:48 PM (see arrow 1) and was tripped by and during the constant operation. Overheating occurred when the Temp Air process value (PV) reached the SP value. For further analysis, data points of the trend graph may be downloaded via the trend graph manipulation buttons (see arrow 2). Refer to Section 4.9.7 for further details. This trend graph is essentially the trend graph invoked in the **Monitor** page. 
    ...
    ![Details of the selected alarm](https://bitbucket.org/repo/yRoG7Eb/images/3000926666-S5_4_1-step2-002a.PNG)
...
![A table listing operating modes](https://bitbucket.org/repo/yRoG7Eb/images/4127612676-S5_4_2-mode-display-003a.PNG)
...
1. Locate entry 135 (first column) for the **Alarm**, as depicted in the figure below. Press the trend graph icon (see arrow). 
    ...
    ![Viewing trend graph and details of the selected alarm](https://bitbucket.org/repo/yRoG7Eb/images/2676937678-S5_4_2-step1-002a.PNG)
...
2. The timeline in the trend graph specifically covers the alarm mode that occurred at 3:41 PM. According to the plot, alarm was tripped due to overheating that occurred when the Temp Air process value (PV) reached the SP value. Data points of this graph may be downloaded (see arrow 2) for analysis. Refer to Section 4.9.7 for further details. 
    ...
    ![Details of the selected alarm](https://bitbucket.org/repo/yRoG7Eb/images/3151710646-S5_4_2-step2-002ab.PNG)
...
![Donut chart display of the overall history of the chamber](https://bitbucket.org/repo/yRoG7Eb/images/3995959319-S5_4-op-stats-001.PNG)
...
![Installed version page](https://bitbucket.org/repo/yRoG7Eb/images/2028707115-S5_6_1-subpage1a.PNG)
...
![Over-the-Air Update setup page](https://bitbucket.org/repo/kMrjrgg/images/1079910449-S5_6_2-subpage2a.PNG)
...
4. Press **Setup** (see arrow 1) followed by **ROM/Firmware Information**; press **Manual Update** subpage (2), then press **Browse** (3) to select the update package from the list on the USB device and press **Accept**. 
    ...
    ![Apply firmware update](https://bitbucket.org/repo/yRoG7Eb/images/2491955005-S5_6_3-ROM-info-p3-002ab.PNG)
...
4. Access the **ROM/Firmware Information** page.
    ...
    ![Drag and drop the update package](https://bitbucket.org/repo/yRoG7Eb/images/2349967590-S5_6_4-ROM-info-p3-003a.PNG)
...
![Rollback a firmware update](https://bitbucket.org/repo/yRoG7Eb/images/4148802009-S5_6_5-rollback-001a.PNG)
...
![Operate Defrost mode](https://bitbucket.org/repo/yRoG7Eb/images/3827918121-S8_4_3-defrost-0001b.PNG)
...
4. Select one Constant mode (say, Constant 1); make notes of its original settings. Set target temperature to a minimum 70 degrees and set humidity and refrigeration control OFF. (It is unnecessary with temperature-only chambers.)
    ![Set Temp to 70, Humi/Refrig Off for Constant 1](https://bitbucket.org/repo/yRoG7Eb/images/307414286-S8_4_3-Step4-TH-off-Const1a.PNG)
...
![Device total run time](https://bitbucket.org/repo/yRoG7Eb/images/854185372-S5_8-time-meter-page-001a.PNG)
...
1. Press **Setup** in the (left) menu bar (see arrow 1). Press **Set Time Meters** (arrow 2). 
    ...
    ![Steps to accessing Set Timer Meters from the Menu bar](https://bitbucket.org/repo/yRoG7Eb/images/2310940074-S5_8-step1-001bba.PNG)

2. Press the reset button of humidity system (arrow 1). Press Yes (arrow 2).  

    ![Resetting time meters of humidity system](https://bitbucket.org/repo/yRoG7Eb/images/1216486535-S5_8-step2-000a.PNG)

3. The humidity system time meter has been reset.  

    ![Time meter of humidity system has bee nreset](https://bitbucket.org/repo/yRoG7Eb/images/335941189-S5_8-step3-001a.PNG)
...
![Back trace page listing back trace data for each alarm occurrence](https://bitbucket.org/repo/yRoG7Eb/images/2707886627-S5_9-back-trace-data-000a.PNG)
...
3. Press **Setup** in the menu bar (see arrow 1). Press the **Set Back Trace** tab (see arrow 2). 
    ...
    ![Accessing the Back Trace page](https://bitbucket.org/repo/yRoG7Eb/images/3438037417-S5_9-step1-001a.PNG)

4. Locate alarm ID 003-3000 (see arrow 1). Press the export button (see arrow 2) to export the data file out to the USB device.   

    ![Exporting back trace data for ALM 003-3000](https://bitbucket.org/repo/yRoG7Eb/images/1226316684-S5_9_1-step3-000ab.PNG)
...
1. Press the **Manual Trigger** button (see arrow 6). 
    ...
    ![Manually creating back trace data](https://bitbucket.org/repo/yRoG7Eb/images/873379190-S5_9_2-step1-000a.PNG)
...
2. The GL controller reads the most recent back trace log and generates the data which may take between 5 to 8 minutes to complete, as indicated by the notification message and the rendering arrow.  
    ...
    ![Rendering back trace data](https://bitbucket.org/repo/yRoG7Eb/images/694942249-S5_9_2-step2-002a.PNG)
...
3. Once data generation is complete, the data file is populated at the bottom of the list. To fetch the data, press the export button (see arrow).   
    ...
    ![Back trace data from manual rendering](https://bitbucket.org/repo/yRoG7Eb/images/2413965673-S5_9_2-step3-001a.PNG)
...
### 6.10.1 Setting Logging Interval and Operating Mode 
...
### 6.10.3 Trend Graph View Options
...
![Accessory page with HMI screensaver and power management options](https://bitbucket.org/repo/yRoG7Eb/images/1616749110-S5_11-accessory-001ab.PNG)
...
![Home page in edit mode](https://bitbucket.org/repo/yRoG7Eb/images/251006935-S6_12-home-003a.PNG)
...
![S6_12-home-003bba.PNG](https://bitbucket.org/repo/yRoG7Eb/images/2901153180-S6_12-home-003bba.PNG)
...
![Widget selection and its menus](https://bitbucket.org/repo/yRoG7Eb/images/3176247319-S6_12-widget-selection-page-001a.PNG)
...
![General Link page](https://bitbucket.org/repo/kMrjrgg/images/1849484488-S6_12_1-links-001.PNG)
...
![Monitor Link page](https://bitbucket.org/repo/kMrjrgg/images/313774186-S6_12_1-monitor-001.PNG)
...
![Operation Link page](https://bitbucket.org/repo/kMrjrgg/images/1969713226-S6_12_1-startstop-001.PNG)
...
![Color selection options](https://bitbucket.org/repo/kMrjrgg/images/2953613789-S6_12_1-colors-001.PNG)
...
3. Press the edit button in the secondary menu (see arrow).
    ...
    ![Set the Home page in edit mode](https://bitbucket.org/repo/kMrjrgg/images/1006079423-S6_12_2-step3-001a.PNG)

4. Press the edit button of the desired widget to be edited (see arrow). Example: Edit the *Start Prog. 1* widget.   

    ![Select a widget or link for editing](https://bitbucket.org/repo/kMrjrgg/images/4269976903-S6_12_2-step4-001a.PNG)
...
5. Select a new widget to replace the current one. Example: Select *Set Sampling* (see arrow). **_Note:_** Program 2 or 3, etc., may be selected. This example illustrates that any widget can be used as a replacement. To remove the selected (current) widget, press **Delete**; to close the widget selection window, press **Close**. 
    ...
    ![Select a new widget or delete the current one](https://bitbucket.org/repo/kMrjrgg/images/4259717268-S6_12_2-step5-001aa.PNG)
...
6. Press the check button, followed by Yes (in dialog box), to save the setting. Or, press the back button followed by Yes to cancel the editing task.
    ...
    ![Save new settings or cancel entire operration](https://bitbucket.org/repo/kMrjrgg/images/4111005989-S6_12_2-step6-001a.PNG)
...
4. Press the plus (+) button to create a new widget (see arrow). 
    ...
    ![Creating a new widget](https://bitbucket.org/repo/kMrjrgg/images/1671121483-S6_12_3-step4-001a.PNG)
...
6. Press (or Click) and drag the widget to a desired location. 
    ...
    ![Positioning the widget in the layout](https://bitbucket.org/repo/kMrjrgg/images/2751405702-S6_12_3-step6-001a.PNG)

7. Press the edit button of the widget to create a new link (see arrow). 

    ![Editing the new widget](https://bitbucket.org/repo/kMrjrgg/images/2095987255-S6_12_3-step7-001a.PNG)
...
![The Set Communication page](https://bitbucket.org/repo/yRoG7Eb/images/1213643087-S6_1-set-comm-003a.PNG)
...
![RS-485 protocol and setting](https://bitbucket.org/repo/yRoG7Eb/images/3989606209-S6_1-RS485-cfg-002a.PNG)
...
![LAN network configuration and protocol](https://bitbucket.org/repo/yRoG7Eb/images/3953050056-S6_1_4-LAN-001a.PNG)
...
![Command prompt and response buffer of LAN Communication Test page](https://bitbucket.org/repo/yRoG7Eb/images/3641070169-S6_1_5-cmd-prompt-001a.PNG)
...
**_Procedure:_** LAN Communication Test on HMI or Web Display 
...
1. Press/click **Setup** (in the menu bar or main home page); press/click Configuration; press/click Set Communication; press/click LAN Communication Test (see arrow).  
    ...
    ![Command prompt and response buffer](https://bitbucket.org/repo/yRoG7Eb/images/911988068-S6_1_5-cmd-hmi-001a.PNG)
...
2. In the command prompt (see arrow), enter: **date?** and press Enter; enter: **rom?** and press Enter; enter: **temp?** and press Enter. Results are shown as follows. 
    ...
    ![Command data and response data](https://bitbucket.org/repo/yRoG7Eb/images/609353641-S6_1_5-step2-001a.PNG)
...
**_Procedure:_**  Remote control via PuTTY 
...
2. Look up the IP address of the GL controller on the Set Communication page, indicated by the IPv4 Address field, under the **eth0** column (see arrow).  
    ...
    ![How to locate IP address of GL controller system](https://bitbucket.org/repo/yRoG7Eb/images/3188314483-S6_1_5-network-status-001a.PNG)
...
3. Launch PuTTY on your PC and follow the procedure  in the diagram to connect to the GL controller.
    ...
    ![Network configuration on PuTTY](https://bitbucket.org/repo/yRoG7Eb/images/2258019861-S6_1_5-putty-comm-001.PNG) 
 
4. Enter "date?" and press Enter; enter "rom?" and press Enter; enter "temp?" and press Enter. Results are shown below.

    ![PuTTY input commands and output responses](https://bitbucket.org/repo/yRoG7Eb/images/1264660407-S6_1_5-putty-cmds-001.PNG) 
...
![Date/Time setting on HMI](https://bitbucket.org/repo/yRoG7Eb/images/138463195-S6_2-datetime-hmi-002aa.PNG)
...
**_Procedure:_**  Date/Time and local time zone adjustment on HMI
...
![Date/Time setting on Web display](https://bitbucket.org/repo/yRoG7Eb/images/4068765571-S6_2-datetime-web-002a.PNG)
...
![Manually adjusting date/time](https://bitbucket.org/repo/yRoG7Eb/images/2307331095-S6_2_2-manual-datetime-setting-001bb.PNG)

**_Procedure:_** Manual Date/Time Setting 
...
![NTP setting and adjustment](https://bitbucket.org/repo/yRoG7Eb/images/3188116534-S6_2_3-ntp-001a.PNG)
...
![Operation Process options](https://bitbucket.org/repo/yRoG7Eb/images/834206548-S6_3-op-process-001a.PNG)
...
![Users settings page](https://bitbucket.org/repo/yRoG7Eb/images/795481158-S6_4-user-accnt-001a.PNG)
...
![The nomenclature of the User Settings submenu](https://bitbucket.org/repo/yRoG7Eb/images/1045510844-S6_4-user-accnt-002a.PNG)
...
![Creating or Adding a new user account](https://bitbucket.org/repo/yRoG7Eb/images/260381379-S6_4_1-add-user-002a.PNG)
...
![Attainment range settings](https://bitbucket.org/repo/yRoG7Eb/images/2858873299-S6_5-attainment-range-001.PNG)
...
![Temp/Humi attainment range setup](https://bitbucket.org/repo/yRoG7Eb/images/1645091637-S6_5-attainment-setpoint-graph-001.PNG)
...
![Names and labels of time signals](https://bitbucket.org/repo/yRoG7Eb/images/3557207195-S6_7-TS-005a.PNG)
...
![Effects of time signal names and labels](https://bitbucket.org/repo/yRoG7Eb/images/4168980682-S6_7-TS-006-eg01-eg02a.PNG)
...
2. Enter "Dry Air Purge" in the field indicated by callout 1; enter "DAP" indicated by callout 2, "Start" by callout 3 and "Stop" by callout 4. 
    ...
    ![Example: Customizing Time Signal 1 with descriptive names](https://bitbucket.org/repo/yRoG7Eb/images/3022334899-S6_7-step2-002a.PNG)

3. Save the setting using the **Save** icon (callout 5) and confirm the action in the pop-up dialog. 

## 7.8 Set Chamber Details 

Chamber setting details is not available via the GL controller software system. 
...
**_Note:_** Customization options differ slightly between the HMI display and the Web display.  Only three options--startup display tab, user interface theme and sub-tab position memorization--are available for customization via the remote operation on the Web display. 

### 7.9.1 Display Setup on HMI 

The label associated with each button indicates its specific setting and behavior. To customize the setting, press the desired button. 

![Display options on HMI setting](https://bitbucket.org/repo/yRoG7Eb/images/3796118120-S6_9-hmi-display-001.png)

### 7.9.2 Display Setup on Web Display  

The label associated with each button indicates its specific setting and behavior. To customize the setting, press the desired button. 

![Display options on Web display setting](https://bitbucket.org/repo/yRoG7Eb/images/1505897642-S6_3-web-001.PNG)

## 7.10 Set Option 

The **Set Option** has a few setting options on proportional band, integral and derivative.  

![GL controller set option](https://bitbucket.org/repo/yRoG7Eb/images/3355872501-S6_10-set-option-001.PNG)

## 7.11 Set Language 

The default language is English. Set your preferred language by selecting one of the buttons. For a remote access via a Web browser, the browser determines the selected language.

![Select your preferred language](https://bitbucket.org/repo/yRoG7Eb/images/3814309202-S7_11-language-support-002.PNG)
...
![Email configuration page](https://bitbucket.org/repo/yRoG7Eb/images/1708017426-S6_12-set-email-001ab.PNG)
...
### 7.12.1 Set Email: Password Recovery 
...
![Enter the admin email for password recovery](https://bitbucket.org/repo/yRoG7Eb/images/512749482-S6_12_1-password-recovery-002a.PNG)
...
### 7.12.2 Set Email: Alert Email Settings 
...
3. Additional email can be added by clicking the **Add** button. 
    ...
    ![Setting alert email options](https://bitbucket.org/repo/yRoG7Eb/images/40339246-S6_12_2-step4-email-setting-001a.PNG)
...
![Alarm and Warning beep level](https://bitbucket.org/repo/yRoG7Eb/images/2321439942-S6_13-sound-page-001.PNG)
...
![Volume control and adjustment](https://bitbucket.org/repo/yRoG7Eb/images/421474405-S6_13-sound-setting-001aa.PNG)
...
![Macros menu and its accessibility](https://bitbucket.org/repo/yRoG7Eb/images/1027942748-S6_15-macros-web-001a.PNG)
...
![Macros operation page](https://bitbucket.org/repo/yRoG7Eb/images/3442052129-S6_15-macros-ui-002.PNG) 
...
### 7.15.2 Example: A Macro Script with Alarm Alert
...
**_Procedure:_** To construct the macro script, proceed as follows. 
...
1.  Plug a Cat5 or Cat6 Ethernet cable into the RJ-45 Ethernet port at the rear of the chamber (see arrow); this can be done while the GL controller system is still running. **_Note:_** Ethernet connection on the GL controller, like any other network devices, is hot-pluggable. 
    ...
    ![Connecting Ethernet cable](https://bitbucket.org/repo/yRoG7Eb/images/4166753972-S7-step2-001a.PNG)

2.  Plug the other end of the cable into an Ethernet port (or a router) that connects to the main network.

    ![DHCP network setup](https://bitbucket.org/repo/yRoG7Eb/images/178688635-S7_3_1-step2-001a.PNG)
...
3.  After about 30 seconds, press the hamburger menu in the status bar (1), followed by Configuration (2) and Set Communication (3) in the system menu, as depicted in the following figure.
    ...
    ![Looking up GL controller hostname and IP address](https://bitbucket.org/repo/yRoG7Eb/images/2575102693-S7_3_1-step3-002a.PNG)
...
4. The hostname of this GL controller system is **GL-EPL-3-P300**, indicated by callout (1). The hostname of your GL controller will be different and unique, which is associated with the registered serial number. The IP address of the GL controller is listed next to **IPv4 Address**, indicated by callout (2); it is shown as **10.30.100.190**. **_Note:_** The IP address of the GL controller is assigned to **eth0**. Thus, the IP address under the **eth0** column is the one used by the GL controller to join the main network. The IP address (192.168.1.100) assigned to (and listed under) **eth1** is for internal communication between the GL controller and the PLC.
    ...
    ![Hostname and IP address of GL controller](https://bitbucket.org/repo/yRoG7Eb/images/1833686550-S7_3_1-step4-002a.PNG)
...
![Fallback IP address](https://bitbucket.org/repo/yRoG7Eb/images/2985967273-S7_4_1-gl-fallback-cfg-001a.PNG)
...
2. Set up Ethernet connection as depicted in the diagram. 
    ...
    ![Static network configuration](https://bitbucket.org/repo/yRoG7Eb/images/691940129-S7_5-gl-static-network-002a.PNG)
...
5. Point and Right-Click the “Local Area Connection” icon, then click Properties from the drop-down menu (follow the arrows in the figure). **_Note:_** The Local Area Connection icon is the one connected to the GL controller (or a hub). It is important to access the correct icon in case the PC has multiple Ethernet ports.
    ...
    ![Selecting the right Local Area Connection](https://bitbucket.org/repo/kMrjrgg/images/316319689-static-cfg-1a.PNG)
...
6.  In the “Local Area Connection Properties” window, confirm that the check mark is placed in front of “Internet Protocol Version 4 (TCP/IPv4)”, as depicted in the figure. If not, check it. Click to highlight “Internet Protocol Version 4 (TCP/IPv4)” and then click Properties in the lower-right corner.
    ...
    ![Setting TCP/IPv4 properties](https://bitbucket.org/repo/kMrjrgg/images/2493799905-static-cfg-2a.PNG)
...
9. Turn on “Validate settings upon exit” with a check mark and click OK, as illustrated in the following figure.
    ...
    ![The complete static IP config on the TCP/IPv4 connection](https://bitbucket.org/repo/kMrjrgg/images/2958266862-static-cfg-3a.PNG)
...
11. Returning to the GL controller: On the GL controller HMI, press the hamburger menu in the status bar (1), followed by Configuration (2) and Set Communication (3) in the system menu, as depicted below.
    ...
    ![Looking up GL controller hostname and IP address](https://bitbucket.org/repo/yRoG7Eb/images/3032867281-S7_4_1-step11-001a.PNG)
...
12. The fallback IP address used by the GL controller is listed next to **IPv4 Address** under **eth0** (see arrow), shown as **192.168.0.83**. **_Note:_** The GL controller IP address is assigned to **eth0**. The IP address (192.168.1.100) assigned to (and listed under) **eth1** is for internal communication between the GL controller and the PLC.
    ...
    ![Fallback IP address used by GL](https://bitbucket.org/repo/yRoG7Eb/images/993438973-S7_4_1-fallback-ip-001a.PNG)

13. To access the GL controller, open a Web browser on your PC and navigate to:  http://192.168.0.83/

    (INSERT NEW WEB PAGE HERE) 
...
![GL controller static network with multiple PCs](https://bitbucket.org/repo/yRoG7Eb/images/3828024261-S7_4_2-static-ip-network-0011.PNG)
...
2. Set up Ethernet connection as depicted in the following diagram.
    ...
    ![Static network configuration](https://bitbucket.org/repo/yRoG7Eb/images/754414513-S7_5-gl-static-network-001a.PNG)
...
3. On the GL controller HMI, press the hamburger button (1) in the status bar. Check to confirm the floating keyboard is enabled under the system menu. A diagonal bar over the keyboard indicates it is disabled. Press the keyboard (2) to enable it; press Configuration (3), followed by Set Communication (4), as depicted in the figure.
    ...
    ![Looking up GL controller hostname and IP address](https://bitbucket.org/repo/yRoG7Eb/images/956115099-S7_5-step3-002a.PNG)
...
4. Press Set LAN (Network Setup) page, then uncheck the DHCP box (see arrow 1); enter **10.30.200.247** in IP address field (see arrow 2). Enter the rest of the parameters listed in the table above, as depicted in the figure. Press Save (arrow 3) and confirm the action. 
    ...
    ![Configure custom static IP](https://bitbucket.org/repo/yRoG7Eb/images/3913041737-S7_5-step4-custom-static-001aa.PNG)
...
5. Back on the Set Communication page, confirm that your custom IP setting is displayed under the **eth0** column, as depicted in the following figure. 
    ...
    ![Confirming static IP address](https://bitbucket.org/repo/yRoG7Eb/images/1286559998-S7_5-step5-001a.PNG)
...
GL controller can communicate with each other on the local network. The hostname in the status bar itself is a clickable link; when clicked, a drop-down menu displays a link to the Network Monitor page and a list of clickable links to other GL controller systems detected on the local network.

![List of GL Controller on the local network](https://bitbucket.org/repo/yRoG7Eb/images/2210352599-S8-network-monitor-001aa.PNG)
...
## 9.1 Network Monitor Page and EWC

The Network Monitor page can perform as a central server monitor where all the GL controller systems on the local network can be displayed on a single monitor, as depicted in the following figure. A operator can remotely monitor and manage all the GL controller systems from a centralized location.
...
| Step No. | Temp SP | Temp Mode |  Humi SP | Humid Mode |  Time (h:min) | Refrig  |TS 1 | TS 2 | Counter Step | Counter Count | 
|----------|------|-----------|-------|-------|--------------|---------|-----|------|----|----| 
...
<table>
  <tr>
    <th>Precessing at End of Operation</th>
...
![Program with multiple looped counters](https://bitbucket.org/repo/yRoG7Eb/images/3818980958-appdxa-2-3.PNG) 
...
|------|---------------|------------|
| HMI / Display | 10.1-inch TFT LCD touch screen display </br> 1280x800px resolution </br> High brightness: 850 cd/m<sup>2</sup> </br> Half life period: 50,000h </br> Video Interface: HDMI </br> Touch Panel Interface: USB-C </br> Power Supply: Power Jack (DC 7.0V - 14.0V) |User Interface for GL Controller and Chamber Operation     |
