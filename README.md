# GL Controller and System Manual
...
This short documentation outlines the necessary procedure(s) to set up and process PDF from GitHub Mardown source code to PDF via LaTeX source code via BASH scripts using *sed* and other BASH commands to inject and modify LaTeX directives and preambles to produce PDF in the format and layout required by ESPEC documentation format requirements.

### What is this repository for? 

* Covert Markdown source code of the online wiki manual and process it into PDF version for distribution to customers

* Version of document: The current version of the manual; V4r1v2 (Version 4 Release 1 version 2) to conform with the version of the software release for the GL controller
...
* This branch is maintained by Paul Nong-Laolam (ESPEC North America, INC.). Any questions may be addressed to <pnong-laolam@espec.com>.
