...
\input{theme} % See themes.tex for details 
\input{callpkgs} % See callpkgs.tex for details 

\title{ESPEC GL Controller}

% A subtitle is optional and this may be deleted
\subtitle{Introducing GL Controller System \\ Applications \& Customer Engineering \\ (T-Series Background)}
