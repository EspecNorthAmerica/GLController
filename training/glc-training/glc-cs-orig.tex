...
\title{ESPEC GL Controller Software}

% A subtitle is optional and this may be deleted
\subtitle{GL Software/Chamber Operation: Customer Support Team}
...
\begin{frame}{ESPEC GL Controller Software}
  \tableofcontents
...
\begin{itemize}  
    \item What is GL Controller? 
    \item Not sure yet to include 
    \item What is EWC V3? 
...
GL is part hardware and part software that makes the "GL chamber." The software part is written in CODESYS; the harware part makes up the Input/Out board (I/O board).    
\begin{figure} [hbt!] 
\centering
