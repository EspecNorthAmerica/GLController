...
{\bf{Good News?}} 
 T-series chamber configuration remains unchanged (still using Allen Bradley PLC). Reason: Major overhaul and reprogramming are required to replace Allen Bradley, quite time consuming. API of GL system will be ported to EWC to support T-series for improved performance.  
