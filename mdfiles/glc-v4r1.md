...
![GL controller as a standalone system](https://bitbucket.org/repo/yRoG7Eb/images/921358877-S2_1_1N-standalone-004a.PNG)
...
![GL controller as a networked system](https://bitbucket.org/repo/yRoG7Eb/images/3796224613-S2_1_2N-gl-homepage-network-003a.PNG)
...
![The Setup page](https://bitbucket.org/repo/yRoG7Eb/images/1269155203-S4_3_5-setup-menu-001a.png)
...
![GL controller UI is locked out](https://bitbucket.org/repo/yRoG7Eb/images/2961643740-S2_6_2N-login-002a.PNG)
...
![Set Protection page with options to enable or disable remote access](https://bitbucket.org/repo/yRoG7Eb/images/2021071933-S6_5-set-protection-001a.png)
...
![GL controller UI on a Web browser](https://bitbucket.org/repo/yRoG7Eb/images/3007255201-S6_5-set-protection-web-002.png)
...
2. Access the Home page and press **Set Protection (User Settings)** (see arrow). 
    ...
    ![Accessing **Set Protection** settings option](https://bitbucket.org/repo/yRoG7Eb/images/3119455434-SN2_10_1-set-protection-001.png)
    ...
    **_Note:_** If this button is not available, select **Setup** (in the menu bar), then press the **Set Protection (User Settings)** button (see arrow).
    ...
    ![Accessing **Set Protection** page from the Setup menu](https://bitbucket.org/repo/yRoG7Eb/images/1571179245-SN2_10_1-step3-001a.png)

3. Press the **Monitor and Control** button in the Remote TCP/IP Communication field (see arrow) 

    ![Enabling remote TCP/IP communication](https://bitbucket.org/repo/yRoG7Eb/images/936457416-SN2_10_1-step4-001a.png)
...
3. Press the **HTTP/HTTPS Access** button (see arrow), followed by **Yes** to confirm the action.
    ...
    ![Enabling local network remote access on GL controller](https://bitbucket.org/repo/yRoG7Eb/images/3200028559-SN2_10_2-step3-001a.png)
...
![GL controller on a Web browser](https://bitbucket.org/repo/yRoG7Eb/images/2508351595-SN2_10_2-web-access-example1a.png)

GL Controller System accessed and displayed via its Hostname:

![GL controller on a Web browser](https://bitbucket.org/repo/yRoG7Eb/images/1183325582-SN2_10_2-web-access-example2a.png)
...
2. Log out of localhost by pressing the user localhost icon (see arrow) followed by the **Log Out** button (see arrow).
    ...
    ![Logging out of the localhost account](https://bitbucket.org/repo/yRoG7Eb/images/4222829398-S2_11_1-step2-logout-localhost-001a.png)
...
4. Log in to the admin account using admin credentials, followed by the **Submit** button (see arrow). Refer to Section 2.6.3 for details.  
    ...
    ![Logging in to admin account](https://bitbucket.org/repo/yRoG7Eb/images/579487506-S2_11_1-step4-logging-into_admin-001a.png)
...
5. Access the hamburger button in the status bar (see callout 1), select Configuration (see callout 2), followed by Email (see callout 3). _**Note:** Another way to access Email page is from the home page **Setup** button or the **Setup** menu, then select Configuration and Email._ Our approach here is more direct.
    ...
    ![Accessing the Email setup page](https://bitbucket.org/repo/yRoG7Eb/images/1911056020-S2_11_1-step5-system-menu-001ab.png)
...
6. To set up admin account recovery, enter your e-mail address in the **Account Recovery E-Mail** field (see top-right arrow). To set alarm alert via e-mail, enter the recipient e-mail address in the **Alarm Recipients** field (see bottom-right arrow). Additional recipient e-mails may be added using the **Add** button.    
    ...
    ![Entering e-mail address for admin account recovery](https://bitbucket.org/repo/yRoG7Eb/images/3932164582-S2_11_1-step6-email-setting-001a.png)
...
2. Enter the admin username (admin), then press the **Admin Account Recovery** button (see arrow). 
    ...
    ![Accessing the account recovery page](https://bitbucket.org/repo/yRoG7Eb/images/1890319025-S2_11_2-step2-001a.png) 
...
3. (a) If you have set up an account recovery in Section 2.11.1 with your e-mail address, and your GL system is connected to the main network, select the **Send Recovery E-Mail** button (see callout 1). A link to reset the admin account is sent to your e-mail account; open the e-mail and click on the link to access the GL system and set the admin password. (b) If you did not set up an account recovery in Section 2.11.1, copy the contents in the **Message** box (see callout 2) and compose an e-mail based on the given instruction for **To** and **Subject**, ESPEC will respond with a link to access your GL system. (c) Or, with your smartphone, you can use the QR code (see callout 3) to send a message to ESPEC for account recovery. 
    ...
    ![Resetting the admin account based on the three options available to you](https://bitbucket.org/repo/yRoG7Eb/images/2696323673-S2_11_2-step3-reset-admin-account-002a.png)
...
![A list of available and supported language on GL controller system](https://bitbucket.org/repo/yRoG7Eb/images/380079532-S2_12-language-selection-001.png)
...
1. Press the **Set Language** button in the home page (see arrow). 
     ...
     ![Accessing the Set Language page](https://bitbucket.org/repo/yRoG7Eb/images/602983469-S2_12-step1-Set-Language-button-001a.png)
...
1. Press the hamburger button (see callout 1); select **Configuration** (callout 2), followed by **Set Language** (callout 3)
    ...
    ![Accessing Set Language under the system menu](https://bitbucket.org/repo/yRoG7Eb/images/2719949474-S2_12-procedure3a.png)
...
![Monitor Page 1: Information page of Standby mode](https://bitbucket.org/repo/yRoG7Eb/images/2518384625-S4_9_2-page1-stdby-001a.PNG)
...
![Two separate counters in a program](https://bitbucket.org/repo/kMrjrgg/images/1994035793-S5_3_1-counter-ex1-001.PNG)

The following figure depicts the actual markings of these two separate counters within the program. 

![Actual program containing two separate coutners](https://bitbucket.org/repo/kMrjrgg/images/3647257293-S5_3_1-counter-ex1-002.PNG)  
...
![Two separate counters nested within the program](https://bitbucket.org/repo/kMrjrgg/images/2591358377-S5_3_1-counter-ex2-001.PNG)

The following figure depicts the actual markings of these two separate counters nested inside the program.

![Actual program containing two nested counters](https://bitbucket.org/repo/kMrjrgg/images/1348622529-S5_3_1-counter-ex2-002.PNG)
...
![Two separate counters combine the total number of cycles](https://bitbucket.org/repo/kMrjrgg/images/3037704782-S5_3_1-counter-ex3-001.PNG)
...
![An impossible counter nesting](https://bitbucket.org/repo/kMrjrgg/images/4175884769-S5_3_1-counter-ex4-001.PNG)
...
![S5_3_1-counter-ex4-001a.PNG](https://bitbucket.org/repo/yRoG7Eb/images/2270811692-S5_3_1-counter-ex4-001a.PNG) 
...
![Trace of steps executed in disordered behavior](https://bitbucket.org/repo/yRoG7Eb/images/2286653660-S5_3_1-counter-ex4-002.PNG)
...
![Two counters with end step and start step locked in together](https://bitbucket.org/repo/yRoG7Eb/images/3968327399-S5_3_1-counter-ex5-001.PNG)
...
![Program without counters](https://bitbucket.org/repo/yRoG7Eb/images/2317935606-S5_3_6-image-001.PNG)

**_Procedure_**: Step-Wise Method 

1. Press/click the body of Step 3 (see arrow).

    ![Setting counter with Step 3 as the end step](https://bitbucket.org/repo/yRoG7Eb/images/1447191847-S5_3_6-step2-table-wise-001a.PNG)
...
3. Enter 1 in the Count field (see arrow). **_Note:_** By default Step 1 is selected for Start Step.
    ...
    ![Setting Counter 1 with repeat cycle at Step 3](https://bitbucket.org/repo/yRoG7Eb/images/3059144716-S5_3_6-step3-step-wise-prog-001a.PNG)
...
6. Enter 3 in the Count field (see arrow).
    ...
    ![Setting Counter 2 with repeat cycle at Step 9](https://bitbucket.org/repo/yRoG7Eb/images/2869678099-S5_3_6-step6-step-wise-prog-001a.PNG) 
...
1. Switch the editor to Table-Wise method (see arrow).
    ...
    ![Switching to table-wise editing](https://bitbucket.org/repo/yRoG7Eb/images/2540780506-S5_3_6-example-step1-001a.PNG)
...
2. Press/click the Count column (under Counter) on Step 3 and enter 1 in the cell (see arrow). **_Note:_** By default, 1 is selected for the start step (in the Step cell, see arrow).
    ...
    ![Selecting end step of first counter](https://bitbucket.org/repo/yRoG7Eb/images/2074568092-S5_3_6-example-step2-001a.PNG)
...
3. Press/click the Count column (under Counter) on Step 9 and enter 2 in the cell (see arrow). Enter 5 in the Step cell for start step (see arrow).
    ...
    ![selecting end step of second counter](https://bitbucket.org/repo/yRoG7Eb/images/3200941779-S5_3_6-example-step3-001a.PNG)
...
1. Plug in a USB device into the USB port (see arrow) at the front of the chamber. 
    ...
    ![External ports](https://bitbucket.org/repo/yRoG7Eb/images/1703896270-S5_4_1N-external-ports-001a.PNG)    
...
![Data backup via Samba share](https://bitbucket.org/repo/yRoG7Eb/images/2130403341-S6_10-data-download-001.PNG)
...
1. Turn on Samba with the check mark in the box to enable the feature. **_Note:_** If this box is not checked, all the required fields are grayed out (cf. previous figure). 
    ...
    ![Completing the required fields for Samba data backup](https://bitbucket.org/repo/yRoG7Eb/images/2919750157-S6_10-data-download-002.PNG)
...
![LAN network configuration and protocol](https://bitbucket.org/repo/yRoG7Eb/images/3124032764-S7_1_4N-LAN-network-001a.PNG)
...
| CAUTION |
|---------|
|**Keep the beep enabled for instant alarm notification.**  2NEWLINE2 If the beep is turned off, alarm and warning are not notified with sound and are indicated only with red blinking of the operation lamp and on warning occurrence screen. 2NEWLINE2 **Set the beep volume in accordance with the ambient environment.** |
...
| CAUTION |
|---------|
|**Do not attempt to change settings in the Service page.**  2NEWLINE2 Only ESPEC service representatives use this function to adjust the setting parameters. Altering settings without authorization at your own discretion can cause accidents. ESPEC is not responsible for damages or injuries caused by user-adjusted parameters.   |
...
2.  Plug the other end of the cable into an Ethernet port (or a router) that connects to the main network.
    ...
    ![DHCP network setup](https://bitbucket.org/repo/yRoG7Eb/images/1766916705-S8_3N-step2-001a.PNG)
...
2. Set up Ethernet connection as depicted in the diagram. 
    ...
    ![Static network configuration](https://bitbucket.org/repo/yRoG7Eb/images/3958540732-S8_4_1N-gl-static-class-C-network-001a.PNG)
...
![GL controller static network with multiple PCs](https://bitbucket.org/repo/yRoG7Eb/images/414296829-S8_4_2N-gl-fallback-static-IP-001a.PNG)
...
2. Set up Ethernet connection as depicted in the following diagram.
    ...
    ![Static network configuration](https://bitbucket.org/repo/yRoG7Eb/images/2178670663-S8_5N-gl-custom-static-step2-001a.PNG)
...
![Accessing About/License Terms in the status bar](https://bitbucket.org/repo/yRoG7Eb/images/3073468097-gl-status-bar-sys-menu-000a.PNG)
...
![Subpage 1: Software Information of GL Controller](https://bitbucket.org/repo/yRoG7Eb/images/3200454759-system-menu-firmware-002a.PNG)
...
![GL Controller Software Information & Support Page](https://bitbucket.org/repo/yRoG7Eb/images/2495806591-system-menu-001a.PNG)
...
![ESPEC customer support page](https://bitbucket.org/repo/yRoG7Eb/images/254095340-system-menu-support-page-001.PNG)
...
![End-User's Agreement & Copy Right Notice](https://bitbucket.org/repo/yRoG7Eb/images/2924605868-system-menu-p2-copyright-end-user-001a.PNG)
...
![Embedded ESPEC GL Controller Software, User's Manual](https://bitbucket.org/repo/yRoG7Eb/images/2864348590-system-menu-p3-embedded-manual-001b.PNG)
...
![Top view of the AAEON Up2Square Board](https://bitbucket.org/repo/yRoG7Eb/images/3394677708-up2board.PNG)
...
![AEEON Up2Board inside the electrical box of GL chamber](https://bitbucket.org/repo/yRoG7Eb/images/4146339678-up2board-inst-002.jpg)
